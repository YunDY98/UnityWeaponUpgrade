...
namespace Assets.Scripts
{
    public static class Utility 
    {
        ...
        // 등비 수열 구간 합 
        public static BigInteger GeometricSumInRange(BigInteger a,decimal r, int start, int end) 
        {
            if (start >= end)
                return 0;
        ...
        // 등비 수열 합 
        public static BigInteger GeometricSum(BigInteger a,decimal r, int n) 
        {
            ...
            {  
                return BigIntMult(a,(1 - DecimalPow(r,n))/(1-r));
            }
        }
        // 등비 수열 일반항  
        public static BigInteger GeoProgression(BigInteger a,decimal r, int n) 
        {
            if(r == 1)
                return a * n;

            return BigIntMult(a, DecimalPow(r, n - 1));
        }
    

        public static BigInteger BigIntMult(BigInteger a,decimal r,int scale =  1000000000)
        {    
