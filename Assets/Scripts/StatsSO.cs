...
public class StatsSO : ScriptableObject
{
    ...
    public ReactiveProperty<BigInteger> MaxHP = new(100000);
    ...
    public ReactiveProperty<BigInteger> Gold = new (BigInteger.Parse("198635600001000"));
    public ReactiveProperty<BigInteger> AddGoldAmount = new (BigInteger.Parse("10000000000000000"));
